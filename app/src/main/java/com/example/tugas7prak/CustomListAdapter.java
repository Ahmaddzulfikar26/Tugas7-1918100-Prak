...
public class CustomListAdapter extends BaseAdapter {
    ...
    private List<PelabuhanPenyebrangan> movieItems;
    public CustomListAdapter(Activity activity, List<PelabuhanPenyebrangan> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PelabuhanPenyebrangan m = movieItems.get(position);
