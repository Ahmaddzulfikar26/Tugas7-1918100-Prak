...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void CreatePelabuhan(PelabuhanPenyebrangan mdNotif) {
    ...
    public List<PelabuhanPenyebrangan> ReadPelabuhanPenyebrangan() {
        List<PelabuhanPenyebrangan> judulModelList = new ArrayList<PelabuhanPenyebrangan>();
        String selectQuery = "SELECT * FROM " + tb_pelabuhan;
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);
        if (cursor.moveToFirst()) {
            do {
                PelabuhanPenyebrangan mdKontak = new PelabuhanPenyebrangan();
    ...
    public int UpdatePelabuhanPenyebrangan(PelabuhanPenyebrangan mdNotif) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(tb_pelabuhan_nama, mdNotif.get_namaorang());
        values.put(tb_pelabuhan_asal, mdNotif.get_asal());
    ...
    public void DeletePelabuhanPenyebrangan(PelabuhanPenyebrangan mdNotif) {
        SQLiteDatabase db = this.getWritableDatabase();
