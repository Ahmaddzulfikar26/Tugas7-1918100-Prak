...
public class MainUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    ...
                    Easal.requestFocus();
                    Toast.makeText(MainUpdate.this, "Silahkan isi warna", Toast.LENGTH_SHORT).show();
                } else if (Stujuan.equals("")){
                    Etujuan.requestFocus();
                    Toast.makeText(MainUpdate.this, "Silahkan isi warna",
                            Toast.LENGTH_SHORT).show();
                } else {db.UpdatePelabuhanPenyebrangan(new PelabuhanPenyebrangan(Sid, Snama, Sasal, Stujuan));
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                db.DeletePelabuhanPenyebrangan (new PelabuhanPenyebrangan(Sid, Snama, Sasal, Stujuan));
