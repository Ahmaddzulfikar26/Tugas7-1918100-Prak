...
public class MainRead extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private List<PelabuhanPenyebrangan> ListPelabuhanPenyeberangan = new ArrayList<PelabuhanPenyebrangan>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<PelabuhanPenyebrangan> contacts = db.ReadPelabuhanPenyebrangan();
        for (PelabuhanPenyebrangan cn : contacts) {
            PelabuhanPenyebrangan judulModel = new PelabuhanPenyebrangan();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
        ...
        PelabuhanPenyebrangan obj_itemDetails = (PelabuhanPenyebrangan) o;
